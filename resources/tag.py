...
@blp.route("/item/<int:item_id>/tags/<string:tag_id>")
...
class Tag(MethodView):
    ...
    @blp.response(202,description="Deletes a tag if no item is tapepd with it")
    ...
    def delete(self,tag_id):
        ...
        abort(400,message="Could not delete tag.Makes sure tag is not associated with any items, then try again")